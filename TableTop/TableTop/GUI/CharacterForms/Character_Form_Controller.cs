   ...
   class Character_Form_Controller : Character_Form_Controller_Interface
    {
       ...
       /// </summary>
        protected void updatePortrait() 
        {
            ...
            if (!MainGUI.is_gm) //todo: Decouple this section
                GUI_Frame.server.updateUserProfile(GUI_Frame.client_id, character_sheet);
        }
       ...
       /// <summary>
       /// Updates the currently held character_driver sheet's.
       ...
       /// </summary>
        public void save_XML()
        {
            ...
            String file_path = System.IO.Path.GetDirectoryName(Application.ExecutablePath) + @"\Characters\" + MainGUI.gameMode + @"\" + character_sheet.FirstName + "_" + character_sheet.LastName + ".xml";
